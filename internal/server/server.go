...
import (
	...
	"github.com/Prog-Strength/prog-strength-api/internal/dashboard"
	...
	"github.com/Prog-Strength/prog-strength-api/internal/nutritionlookup"
	...
	"github.com/Prog-Strength/prog-strength-api/internal/snapshot"
	"github.com/Prog-Strength/prog-strength-api/internal/steps"
	"github.com/Prog-Strength/prog-strength-api/internal/telemetry"
...
func New(cfg config.Config) (*Server, error) {
	...
	if cfg.VectorMemory.Enabled {
		...
		vmSources := BuildMemorySources(database, chatSQLiteRepo, activityRepo, cfg.VectorMemory)
