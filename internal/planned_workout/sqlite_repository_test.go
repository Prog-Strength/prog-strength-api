...
// keys on, mirroring internal/db/migrate_test.go and the activity tests.
// Foreign keys must be on so planned_workout_exercises → planned_sets
// ON DELETE CASCADE fires during agenda replacement on Update.
